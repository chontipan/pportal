        ...
        <div class="gov">
            <div class="row terminal">
                <div class="col-md-12" style="padding-left: 1px;padding-right: 1px">
                    <div class="title-top">
                        <div class="title">
                            <div style="float: left" class="hi-icon-wrap hi-icon-effect-4 hi-icon-effect-4a"><i class="fa i-gov fa-border hi-icon"></i></div>
                            <h2 style="float: left;  margin-top: 35px;">บริการภาครัฐ</h2>
                        </div>
        ...
        <div class="travel">
            <div class="row terminal">
                <div class="col-md-12" style="padding-left: 1px;padding-right: 1px">
                    <div class="title-top">
                        <div class="title">
                            <div style="float: left" class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a"><i class="fa i-travel fa-border hi-icon"></i></div>
        ...
        <div class="uni">
            <div class="row terminal">
                <div class="col-md-12" style="padding-left: 1px;padding-right: 1px">
                    <div class="title-top">
                        <div class="title">
                            <div style="float: left" class="hi-icon-wrap hi-icon-effect-6 hi-icon-effect-6a"><i class="fa i-uni fa-border hi-icon"></i></div>
